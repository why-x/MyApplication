package com.example.testprint.printutil;

import android.content.Context;

import com.example.testprint.R;
...
public class PrintOrderDataMaker implements PrintDataMaker {
    ...
    public List<byte[]> getPrintData(int type) {
        ...
        try {
            ...
            ArrayList<byte[]> image1 = printer.getImageByte(btService.getResources(), R.drawable.ic_launcher_background);
